...
_Generated: 2026-04-29T23:15:45.527Z_
...
Workspace `mcp.json` _(folder: mercy_works)_

- **c:\Users\BRUNO\Downloads\mercy_works_django\mercy_works\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\BRUNO\AppData\Roaming\Code\User\mcp.json** — _File missing_
