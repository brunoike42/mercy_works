...
_Generated: 2026-07-27T05:35:34.765Z_
...
Workspace `mcp.json` _(folder: bumaali)_

- **e:\DJANGO\New folder\Bumaali\bumaali\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\BRUNO\.claude.json** — _File exists — no servers defined_
